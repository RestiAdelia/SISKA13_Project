        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm text-gray-500">
                    ...
                    <li>/</li>
                    <li><a href="{{ route('kelas.index') }}" class="hover:text-[#560029] transition-colors">Data Kelas</a></li>
                    <li>/</li>
            ...
            >
                ...
                <div class="bg-gray-50/50 px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Perbarui informasi kelas di bawah ini.</p>
                    </div>
                    <div class="hidden sm:block">
                        <span class="px-3 py-1 rounded-full bg-amber-100 text-amber-700 text-xs font-bold border border-amber-200">
                            Edit Mode
                        </span>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8">
                    ...
                    <form action="{{ route('kelas.update', $kelas->id) }}" method="POST" class="space-y-6">
                        ...
                        <div x-data="{
                            mapel: {{ json_encode($kelas->mata_pelajaran ?? ['']) }},
                            updateJSON() {
